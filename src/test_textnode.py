...
class TestTextNodeHTMLNodeConversion(unittest.TestCase):
    def test_text(self):
    ...
    def test_link(self):
        ...
        self.assertEqual(html_node.props["href"], "http://localhost:4040")

    def test_image(self):
        node = TextNode("This is an image", TextType.IMAGE, "http://localhost:4040")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props["src"], "http://localhost:4040")
